...
export default function Chat({ route }) {
    ...
    return (
        <Container>
            <AppHeader
                leftIcon={
                    <ProfileImage image={require('../../assets/images/profileImg.png')}
                        style={{ marginRight: 8 }} height={34} width={34} />
                }
                    ...
                    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss}>
                        <>
                            ...
                            >
                                ...
                                <ChatInput value={text} onChangeText={(val) => setText(val)} onSend={() => { publishMessage(text); setText("") }} />
                            </View>
                        </>
