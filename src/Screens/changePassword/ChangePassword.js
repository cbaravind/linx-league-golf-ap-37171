            ...
            <ScrollView>
                ...
                <Center px="1" >
                    <Box w="100%" p='10px'>
                        ...
                        <Box mt='8'>
                            <InputText
                                value={formData.currentPassword} onChangeText={(val) => setFormData({ ...formData, currentPassword: val })}
                                icon={true} bgcolor={false} greenColor={false} text='Current Password ' />
                        </Box>
                        <Box mt='8'>
                            <InputText
                                ...
                                icon={true} bgcolor={false} greenColor={false} text='New Password ' />
                        </Box>
                        <Box mt='8'>
                            <InputText
