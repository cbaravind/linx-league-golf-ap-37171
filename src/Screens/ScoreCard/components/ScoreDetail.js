...
export default function ScoreDetail({ item }) {
    return (
        <View>
            <View style={{ position: 'absolute', top: 10, right: 0, backgroundColor: colors.background, padding: 5, borderBottomLeftRadius: 10, zIndex: 10 }}>
                <Button style={{ alignContent: 'center', borderTopRightRadius: 0, borderBottomRightRadius: 0 }} colorScheme='green' w='20'>
                    <Text textAlign='center' fontSize={16} fontWeight={'700'} color={colors.white}>ADD Score</Text>
                </Button>
            </View>
            <Box bg='white' p='2' borderRadius={10} mt='4' zIndex={0} pb={'5'} >
                ...
                <Text fontWeight='700' fontSize='16' textAlign={'center'} mt='6' mb='2'>Hole Stats History</Text>
                <Box style={styles.row}>
                    ...
                    >
                        ...
                        <Box alignSelf='center' ml='1' pr='-10'>
                            <ImageBackground style={[styles.verticalImg, { top: 2, right: -21 }]} source={require('../../../assets/images/topChart.png')}>
                                <Box pb={'1'}>
                            ...
                            <Row style={{ marginTop: -10, justifyContent: 'center' }} >
                                ...
                                <Box style={styles.circle} >
                                    <Text style={[styles.smallText,{color:colors.white}]} >Hit</Text>
