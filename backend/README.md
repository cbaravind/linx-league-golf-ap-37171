...
## Project Structure
    ...
    ├── linx_league_golf_ap_37171  # Django project configurations
...
1. Clone this repo and `cd linx_league_golf_ap_37171`
...
2. Clone this repo and `cd linx_league_golf_ap_37171`
